...
public class LegacyAPI {
    ...
    * 
    * @param tempItem - The ItemStack to be updated.
    * @param attribIdent - The identifier of the attributes.
    * @param attributes - A list of attributes to be set.
    * @return The new ItemStack with set Attributes.
    */
	public static ItemStack setAttributes(final ItemStack tempItem, final String attribIdent, final Map<String, Double> attributes) {
		if (!ServerUtils.hasSpecificUpdate("1_13") && attributes != null && !attributes.isEmpty()) {
			try {
				...
				for (String attribute: attributes.keySet()) {
					int uuid = new BigInteger((attribIdent + attribute).getBytes()).intValue();
